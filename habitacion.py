...
frame_amarillo_tamaño = ttk.Label(frame_amarillo, text="560x690", bg="black")

# crear zona 1, que esta a 30 pixeles de arriba y 30 pixeles de la izquierda
frame_zona1 = ttk.Frame(frame_azul, width=500, height=150, bg="red")
frame_zona1.place(x=30, y=30)
frame_zona1_tamaño = ttk.Label(frame_azul, text="500x150", bg="red")

#crear zona 2
frame_zona2 =ttk.Frame(frame_azul, width=630, height=101, bg="green")
frame_zona2.place(x=30, y=180)
frame_zona2_tamaño = ttk.Label(frame_azul, text="630x101", bg="green")

#crear zona 3 
frame_zone3 = ttk.Frame(frame_azul, width=309, height=630, bg="blue")
frame_zone3.place(x=30, y=291)
frame_zone3_tamaño = ttk.Label(frame_azul, text="309x630", bg="blue")
